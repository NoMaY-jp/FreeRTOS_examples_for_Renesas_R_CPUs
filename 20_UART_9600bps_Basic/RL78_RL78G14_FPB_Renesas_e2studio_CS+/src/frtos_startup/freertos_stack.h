...
#define task_CONIO_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  64, 16, 32 ) )
...
#define task_CONIO_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES( 106, 16, 32 ) )
...
#define task_CONIO_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  66, 16, 32 ) )
#define main_task_STACK_BUFF_DEPTH  stackBYTES_TO_DEPTH( stackBUFF_BYTES(   4, 16, 32 ) )
#define IdleTask_STACK_BUFF_DEPTH   stackBYTES_TO_DEPTH( stackBUFF_BYTES(   4, 16, 32 ) )
#define TimerTask_STACK_BUFF_DEPTH  stackBYTES_TO_DEPTH( stackBUFF_BYTES(   0,  0,  0 ) )
...
#define task_CONIO_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  84, 16, 32 ) )
#define main_task_STACK_BUFF_DEPTH  stackBYTES_TO_DEPTH( stackBUFF_BYTES(   4, 16, 32 ) )
#define IdleTask_STACK_BUFF_DEPTH   stackBYTES_TO_DEPTH( stackBUFF_BYTES(  10, 16, 32 ) )
#define TimerTask_STACK_BUFF_DEPTH  stackBYTES_TO_DEPTH( stackBUFF_BYTES(   0,  0,  0 ) )
