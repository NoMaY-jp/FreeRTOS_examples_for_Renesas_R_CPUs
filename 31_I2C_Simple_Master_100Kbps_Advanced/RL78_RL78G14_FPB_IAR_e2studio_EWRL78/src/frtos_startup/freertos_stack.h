...
#define task_DMSLV_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  56, 20, 32 ) )
...
#define task_DMSLV_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  82, 36, 32 ) )
...
/* The stack space for TM3 & IIC00 interrupt is MAX(24, 4) = is 24 */
...
#define task_DMSLV_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  64, 24, 32 ) )
...
/* The stack space for TM3 & IIC00 interrupt is MAX(30, 4) = 30 */
...
#define task_DMSLV_STACK_BUFF_DEPTH stackBYTES_TO_DEPTH( stackBUFF_BYTES(  66, 30, 32 ) )
