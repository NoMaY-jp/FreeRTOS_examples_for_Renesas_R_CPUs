...
/* Start user code for function. Do not edit comment generated here */
    ...
    for (;;)
    {
        U_IICA0_Slave_Operation_Wait( operation_start );
...
static void operation_start(void)
{
    U_IICA0_Slave_Receive_Start( &recv_buff[0], 1, cb_rx_cmd );
}
...
static MD_STATUS cb_rx_cmd(MD_STATUS flag)
{
    ...
    case DEMO_SLAVE_GET_SW_STAT:
        U_IICA0_Slave_Receive2_Start( &recv_buff[1], 1, cb_rx_prm_of_get_sw_stat );
        status = MD_CONTINUE;
        break;
    case DEMO_SLAVE_SET_LED_STAT:
        U_IICA0_Slave_Receive2_Start( &recv_buff[1], 2, cb_rx_prm_of_set_led_stat );
        status = MD_CONTINUE;
        break;
    default:
        configASSERT( ( volatile void * ) NULL );   /* Force an assert. */
...
static MD_STATUS cb_rx_prm_of_get_sw_stat(MD_STATUS flag)
{
    ...
    U_IICA0_Slave_Send_Start( &send_buff[0], 1, cb_tx_res_of_get_sw_stat );
    return MD_CONTINUE;
}
