...
void u_iic00_callback_master_common(MD_STATUS flag);           /* iic00 master common callback */
...
#define r_iic00_interrupt R_CG_ISR_UNUSED(r_iic00_interrupt, 0x7c) /* 0x7c (for ICCRL78) is one of free vectors */
...
* Return Value : None
******************************************************************************/
void u_iic00_callback_master_common(MD_STATUS flag)
{
    u_cg_task_notify_request_from_high_priority_isr( g_iic00_master_task, &g_iic00_master_notification, 0x10000 | flag );
}
...
{
    u_cg_task_notify_requested_from_high_priority_isr( &g_iic00_master_task, &g_iic00_master_notification );
